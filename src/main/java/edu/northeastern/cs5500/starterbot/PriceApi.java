...
public class PriceApi {
    ...
    public String getPrice(String ticker) {
        ...
        if (!priceObj.get("Global Quote").getAsJsonObject().has("05. price")) {
            return "";
        }
        ...
        if (lastTradingDate.replace("\"", "").equals(date)) {
            ...
            return sb.append("After Market Price: ")
                    .append(globalQuoteObj.get("05. price").toString().replace("\"", ""))
                    .append("\tMarket Price: ")
                    .append(globalQuoteObj.get("08. previous close").toString().replace("\"", ""))
                    .toString();
        }
